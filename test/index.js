...
// so I made a script out of girc's internals to create this test data
...
test('signedTypeData', (t) => {
  ...
  const privateKey = ircUtil.sha3('cow');
  const address = ircUtil.privateToAddress(privateKey);
  ...
  t.equal(
      ircUtil.bufferToHex(utils.hashType('Mail', typedData.types)),
      '0xa0cedeb2dc280ba39b857546d74f5549c3a1d7bdc2dd96bf881f76108e23dac2');
  t.equal(
      ircUtil.bufferToHex(utils.encodeData(typedData.primaryType, typedData.message, typedData.types)),
  ...
  t.equal(
      ircUtil.bufferToHex(utils.hashStruct(typedData.primaryType, typedData.message, typedData.types)),
